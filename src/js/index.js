...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "Bárbara";
  if (variables.lastname == null) variables.lastname = "Ulloa";
  if (variables.twitter == null) variables.twitter = "ByanseU";
  if (variables.github == null) variables.github = "byanse";
  if (variables.instagram == null) variables.instagram = "byanse";
